...
The original xv6 project is no longer maintained by MIT and the tooling for installing and running it for MacOS is obselete.
Consider installing the new RISC-V based xv6 instead of the old one which this document describes.
